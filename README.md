...
Documentation online: https://ternaustralia.github.io/ontology_tern-sd/
...
```
docker run --rm -it --name pylode -e ONTOLOGY_FILE=tern-sd.ttl -e OPTIONS="--css true" -v ${PWD}:/pyLODE/src/pylode/input edmondchuc/pylode
```
...
```
docker run --rm --name tbc-shacl-cleaner -e SHACL_FILE="tern-sd.shapes.ttl" -v ${PWD}:/home/input edmondchuc/tbc-shacl-cleaner
```
